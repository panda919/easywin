...
import { View, StyleSheet, TouchableWithoutFeedback, TouchableOpacity, Linking, Image, ScrollView } from 'react-native'
...
const LotsSheet = (props) => {
    let principalLots = [];
    let secondaireLots = [];
    if (props?.selectedConcourLots && props?.selectedConcourLots?.length) {
        props?.selectedConcourLots.forEach((lot) => {
